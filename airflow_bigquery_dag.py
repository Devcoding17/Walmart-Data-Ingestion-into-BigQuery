...
with DAG(
    ...
    with TaskGroup("load_data") as load_data:
        ...
        gcs_to_bq_merchants = GCSToBigQueryOperator(
            ...
            bucket='bigquery-project',
            source_objects=['walmart-ingestion/Merchants/merchants.json'],
            destination_project_dataset_table='eminent-clover-428817-h5.walmart_dwh.merchants_tb',
        ...
        gcs_to_bq_walmart_sales = GCSToBigQueryOperator(
            ...
            bucket='bigquery-project',
            source_objects=['walmart-ingestion/Sales/walmart_sales.json'],
            destination_project_dataset_table='eminent-clover-428817-h5.walmart_dwh.walmart_sales_stage',
            write_disposition='WRITE_TRUNCATE',
            source_format='NEWLINE_DELIMITED_JSON',
        )
    ...
    merge_walmart_sales = BigQueryExecuteQueryOperator(
        ...
        sql="""
            MERGE `eminent-clover-428817-h5.walmart_dwh.walmart_sales_tgt` T
            USING (
              SELECT 
                S.sale_id, 
                S.sale_date, 
              ...
              FROM `eminent-clover-428817-h5.walmart_dwh.walmart_sales_stage` S
              LEFT JOIN `eminent-clover-428817-h5.walmart_dwh.merchants_tb` M
